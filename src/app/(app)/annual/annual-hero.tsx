    ...
    <>
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
        ...
        <div className="rounded-2xl bg-surface px-4 py-3 text-center shadow-sm ring-1 ring-black/5 dark:ring-white/10">
          <p className="text-[18px] font-medium uppercase tracking-wide text-muted">
            {year} Net
          </p>
          <p
          ...
          {netPct !== null ? (
            <p
              className={`mt-0.5 whitespace-nowrap text-lg font-semibold ${
                netTotal >= 0 ? "text-positive" : "text-negative"
              }`}
            >
...
function Stat({
  ...
  return (
    <div className="rounded-2xl bg-surface px-4 py-3 text-center shadow-sm ring-1 ring-black/5 dark:ring-white/10">
      <p className="text-[18px] font-medium uppercase tracking-wide text-muted">{label}</p>
      <p
        className={`mt-0.5 text-3xl font-bold tabular-nums ${tone ?? ""}`}
